...
/**
 * @brief Вибір режиму роботи передатчика/приймача
 * 
 */
...
//#define SX1262_MODEM    //Використовувати радіо-модуль SX1262


String RADIO_NAME = F("RADIO: "); //Строка для друку назви (імені) радіо-модуля
...
#define RADIO_CURRENT_LIMIT 100 //Встановити обмеження струму захисту (за замовчуванням до 80 мА) (допустимий діапазон 45 - 240 мА) УВАГА: встановіть значення 0, щоб вимкнути захист від перевантаження струму

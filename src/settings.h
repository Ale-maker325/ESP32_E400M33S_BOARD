...
#define SPEED_TRANSMIT 500000 //Швидкість передачі даних в мікросекундах (1 000 000 мкс = 1 секунда)


String RADIO_NAME = F("RADIO: "); //Строка для друку назви (імені) радіо-модуля для відображення на дисплеї та в серійному моніторі
...
#define RADIO_OUTPUT_POWER 15   //Встановити вихідну потужність передавача (за замовчуванням 15 дБм)

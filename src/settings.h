...
#define SPEED_TRANSMIT 1000000 //Швидкість повторної циклічної передачі даних у ефір в мікросекундах (1 000 000 мкс = 1 секунда)

//#define BUTTONS //Розкоментувати, якщо потрібно використовувати кнопки для управління при цьому потрібно запаяти перемички кнопок (без запайки кнопок будуть хибні спрацювання)
...
#ifdef FAN_IS_ACTIVE
    #define FAN_ON_POWER 2  //Потужність передавача, при якій вмикається вентилятор (залежить від індивідуальних умов і це потрібно встановлювати індивідуально).
#endif
...
//Ці параметри будуть використовуватися для ініціалізації радіо
    ...
    #define RADIO_SYNC_WORD 0x18    //Встановити слово синхронізації (за замовчуванням 0x18). УВАГА! Значення 0x34 зарезервовано для мереж LoRaWAN і небажано для використання
    ...
    #define RADIO_CODING_RATE 7             //Встановити коефіцієнт кодування (за замовчуванням 7)
    #define RADIO_SYNC_WORD 0x18            //Встановити слово синхронізації (за замовчуванням 0x18). УВАГА! Значення 0x34 зарезервовано для мереж LoRaWAN і небажано для використання
    #define RADIO_OUTPUT_POWER 12           //Встановити вихідну потужність передавача
    #define RADIO_CURRENT_LIMIT 80         //Встановити обмеження струму захисту (за замовчуванням до 80 мА) (допустимий діапазон 45 - 240 мА) УВАГА: встановіть значення 0, щоб вимкнути захист від перевантаження струму
    #define RADIO_PREAMBLE_LENGTH 8         //Встановити довжину преамбули (за замовчуванням 8 символів) (допустимий діапазон 6 - 65535)
    #define RADIO_CRC false                 //Встановити контрольну суму CRC (за замовчуванням вимкнено)
    #define RADIO_TCXO_V 2.4                //Встановити напругу TCXO. Примітка: встановіть значення 0, щоб вимкнути TCXO
    #define RADIO_DIO2_AS_RF_SWITCH true    //Встановити DIO2 як RF Switch (за замовчуванням вимкнено)
#endif
//************************************************************************************************************************************
